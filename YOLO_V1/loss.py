"""
Implementation of YoloV1 Loss Function from the original yolo paper
...
class YoloLoss(nn.Module):
    ...
    def forward(self, predictions, target):
        ...
        iou_b1 = intersection_over_union(predictions[..., 81:85], target[..., 81:85])
        ...
        exists_box = target[..., 80].unsqueeze(3)  # in paper this is Iobj_i
